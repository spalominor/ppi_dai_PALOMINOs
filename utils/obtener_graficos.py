...
def graficar_barras_ano_vehiculos():
    """
    Mostrar estadísticas del número de vehículos por año usando un gráfico de barras.
    """
...
def graficar_boxplot_ano_vehiculos():
    """
    Mostrar estadísticas del estado de los vehículos usando un boxplot horizontal del número de vehículos por año.
    """
    # Número de vehículos por año
    ano_vehiculos_np = df_vehiculos["año"].to_numpy()
    # Contar el numero de vehiculos por cada año
...
# Añadir anotaciones
    plt.text(np.median(vehiculo_ano_frecuencia[1]), 0.9, f'Mediana: {np.median(vehiculo_ano_frecuencia[1])}', 
             horizontalalignment='center', verticalalignment='center', color='red', weight='bold')
    plt.text(np.percentile(vehiculo_ano_frecuencia[1], 25), 1.1, f'Cuartil 1: {np.percentile(vehiculo_ano_frecuencia[1], 25)}', 
             horizontalalignment='center', verticalalignment='center', color='blue', weight='bold')
    plt.text(np.percentile(vehiculo_ano_frecuencia[1], 75), 1.1, f'Cuartil 3: {np.percentile(vehiculo_ano_frecuencia[1], 75)}', 
             horizontalalignment='center', verticalalignment='center', color='blue', weight='bold')
...
def graficar_scatter_ano_vehiculos():
    """
    Mostrar estadísticas del estado de los vehículos usando un scatter plot del número de vehículos por año.
    """
    # Número de vehículos por año
    ano_vehiculos_np = df_vehiculos["año"].to_numpy()
    # Contar el numero de vehiculos por cada año
    ...
    # Plotting
    fig = plt.figure(figsize=(10, 6))
    plt.scatter(vehiculo_ano_frecuencia[0], vehiculo_ano_frecuencia[1], color='skyblue')
...
def graficar_histograma_kilometraje_vehiculos(cortes):
    ...
    # Plotting
    fig = plt.figure(figsize=(10, 6))
    plt.hist(kilometraje_vehiculos_np, bins=bins, color='skyblue', edgecolor='black')

    # Añadir línea horizontal para promedio y mediana
    plt.axvline(x=kilometraje_promedio, color='red', linestyle='--', label=f'Promedio: {kilometraje_promedio} km')
    plt.axvline(x=kilometraje_mediana, color='green', linestyle='--', label=f'Mediana: {kilometraje_mediana} km')
...
def graficar_boxplot_kilometraje_vehiculos():
    ...
    plt.axvline(x=kilometraje_promedio, color='red', linestyle='--', label=f'Promedio: {kilometraje_promedio} km')
    plt.axvline(x=kilometraje_mediana, color='green', linestyle='--', label=f'Mediana: {kilometraje_mediana} km')
    plt.axvline(x=q1, color='blue', linestyle='--', label=f'Q1: {q1} km')
    plt.axvline(x=q3, color='orange', linestyle='--', label=f'Q3: {q3} km')
...
def graficar_barras_kilometros_ano():
    ...
    # Plotting
    fig = plt.figure(figsize=(10, 6))
    plt.bar(ano_vehiculos_np, kilometros_ano_vehiculos_np, color='skyblue')
...
def graficar_histograma_kilometros_ano(cortes):
    ...
    # Plotting
    fig = plt.figure(figsize=(10, 6))
    plt.hist(kilometros_ano_vehiculos_np, bins=bins, color='skyblue', edgecolor='black')

    # Añadir línea para el promedio y la mediana
    plt.axvline(x=kilometros_ano_promedio, color='red', linestyle='--', label=f'Promedio: {kilometros_ano_promedio} km')
    plt.axvline(x=kilometros_ano_mediana, color='green', linestyle='--', label=f'Mediana: {kilometros_ano_mediana} km')
...
def graficar_scatter_kilometros_ano():
    ...
    plt.axhline(y=kilometros_ano_promedio, color='green', linestyle='--', label=f'Kilómetros Promedio: {kilometros_ano_promedio} km')
    plt.axhline(y=kilometros_ano_mediana, color='red', linestyle='--', label=f'Kilómetros Mediana: {kilometros_ano_mediana} km')
...
def graficar_boxplot_kilometros_ano():
    ...
    plt.text(1, quartiles[0], f'Q1: {quartiles[0]} km', horizontalalignment='center', verticalalignment='bottom', fontsize=10)
    plt.text(1, quartiles[1], f'Mediana: {quartiles[1]} km', horizontalalignment='center', verticalalignment='bottom', fontsize=10)
    plt.text(1, quartiles[2], f'Q3: {quartiles[2]} km', horizontalalignment='center', verticalalignment='bottom', fontsize=10)
...
def graficar_pastel_pedidos_dia():
    """
    Graficar un gráfico de pastel para mostrar la proporción de pedidos por día de la semana.
...
fig =     Figure: Objeto de matplotlib que representa el gráfico de pastel.
    ...
    plt.pie(frecuencias, labels=dias_semana, autopct='%1.1f%%', startangle=140)
...
def graficar_histograma_pedidos_por_hora():
    ...
    plt.bar(bins[:-1], frecuencias, width=2, align='center', color='skyblue', edgecolor='black')
