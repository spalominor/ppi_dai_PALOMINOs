...
def main():
    ...
    st.markdown(
        """
        Bienvenido al Gestor de Flotas de Vehículos. Esta aplicación ofrece una solución integral 
        para el manejo eficiente y efectivo de flotas de vehículos, independientemente de su tamaño. 
        Combina análisis de datos, modelado predictivo y tecnologías de geocodificación para abordar 
        necesidades específicas de la industria del transporte, permitiendo a las empresas diferenciarse 
        de la competencia.
        """
    )
    ...
    st.markdown(
        """
        Hasta el momento, la aplicación ofrece las siguientes funcionalidades:
        ...
        - Obtener una recomendación sobre cómo asignar los vehículos a los pedidos según el costo mínimo total.
        """
    )
